...
abstract class MedController {
  Future<void> addMedicine(BuildContext context, Medicmodel medicine);
  Future<void> updateMedicine(BuildContext context, Medicmodel medicine);
  Future<void> deleteMedicine(BuildContext context, int id);
  Future<List<Medicmodel>> getMedicines();
  Future<Medicmodel?> getMedicine(int id);
}
